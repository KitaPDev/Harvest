#define PIN_TDS 35
#define voltageRef 5.0      // analog reference voltage(Volt) of the ADC
#define sampleCount  30           // sum of sample point
int analogBuffer[sampleCount];    // store the analog value in the array, read from ADC
int analogBufferTemp[sampleCount];
int analogBufferIndex = 0,copyIndex = 0;
float averageVoltage = 0,tdsValue = 0,temperature = 22.69;
...
void loop()
{
   ...
   if(millis()-printTimepoint > 800U)
   {
      ...
      for(copyIndex=0;copyIndex<sampleCount;copyIndex++)
