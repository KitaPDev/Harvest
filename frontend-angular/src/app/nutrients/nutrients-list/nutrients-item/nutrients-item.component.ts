...
export class NutrientsItemComponent implements OnInit {
  ...
  onEditNutrient() {
    this.editNutrientDialogService.init(
      this.index,
      this.nutrient.nutrientLabel,
      this.nutrient.part,
      this.nutrient.nutrientType,
      this.nutrient.ccPerLiter,
      this.nutrient.n,
      this.nutrient.p,
      this.nutrient.k
    );
    ...
    this.confirmationDialogService
      .confirm(
        ...
        'Nutrient Label: ' +
          this.nutrient.nutrientLabel +
          '\nPart: ' +
          this.parts[this.nutrient.part - 1] +
          '\nNutrient Type: ' +
          this.nutrientTypes[this.nutrient.nutrientType - 1] +
          '\ncc/liter: ' +
          this.nutrient.ccPerLiter +
          '\nN: ' +
          this.nutrient.n +
