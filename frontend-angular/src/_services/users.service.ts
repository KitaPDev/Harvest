...
export class UsersService {
  ...
  createUser(username: string, password: string, isAdmin: boolean) {
    ...
    this.httpClient.post(USERS_API + '/create', body, httpPostOptions)
    ...
    if (isAdmin) {
      this.confirmationDialogService.confirm(
        ...
        'username: ' + this.usersSource.getValue()[index].username
          ...
          if (confirmed) {
            this.httpClient.post(USERS_API + '/unassign_admin', body, httpPostOptions)
              .subscribe((response: HttpResponse<any>) => {
      ...
      this.confirmationDialogService.confirm(
        ...
        'username: ' + this.usersSource.getValue()[index].username
          ...
          if (confirmed) {
            this.httpClient.post(USERS_API + '/assign_admin', body, httpPostOptions)
              .subscribe((response: HttpResponse<any>) => {
  ...
  changePassword(index: number, oldPassword: string, newPassword: string) {
    ...
    this.httpClient.post(USERS_API + '/change_password', body, httpPostOptions)
      .subscribe((response: HttpResponse<any>) => {
  ...
  deleteUser(index: number) {
    ...
    this.httpClient.post(USERS_API + '/delete', body, httpPostOptions)
      .subscribe((response: HttpResponse<any>) => {
  ...
  updateUsersData() {
    this.fetchUsersData().then((response: HttpResponse<any>) => {
